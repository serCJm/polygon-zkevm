...
import { ModulesConfigType } from "../types.js";
...
export abstract class BaseModule {
	...
	protected config: ModulesConfigType;
	constructor() {
	...
	static async runModule(
		derivedClass: new (...args: any[]) => BaseModule,
		chain?: ChainsType
	) {
		...
		await asyncRetry(operation, handleModuleError, [className, chain]);
	}
}
